...
<html>
    ...
    <body Style="background-image: url('pokeballBK.png'); opacity: 30%;">
        ...
        <div>
            ...
            <h1 Style="font-size: 200%; text-align: center">Welcome to Pokemon Dexter!</h1>
            <p Style="font-size: 150%; text-align: center">The place where one can find all they need to be a Pokemon Master!</p>
            </br>
        </div>
    </body>
</html>
